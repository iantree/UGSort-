# UGSort- A testbed for the UGSort algorithm
The UGSort algorithm is a novel merge based sorting algorithm. This project provides a minimally optimised, optionally instrumented testbed for 
